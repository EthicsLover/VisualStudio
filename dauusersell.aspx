<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dauusersell.aspx.cs" Inherits="dauusersell" %>
...
<body bgcolor="#eeedbb" onload="focus()">
    ...
    <div>
        ...
        <img src="images/zedge3581nl.jpg" style="z-index: 111; left: 264px; width: 258px;
            position: absolute; top: 0px; height: 48px" />
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Style="z-index: 112; left: 360px;
            position: absolute; top: 48px" Text="Register" Width="144px"></asp:Label>
