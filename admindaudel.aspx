<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admindaudel.aspx.cs" Inherits="admindaudel" %>
...
<body bgcolor="#eeedbb">
    ...
    <div>
        <div>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Font-Bold="False" Style="z-index: 101;
            ...
            <asp:Image ID="Image1" runat="server" Height="48px" ImageUrl="~/images/dau.jpg" Style="z-index: 103;
