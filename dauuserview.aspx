<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dauuserview.aspx.cs" Inherits="dauuserview" %>
...
<body bgcolor="#eeedbb">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
            ...
            Style="z-index: 100; left: 84px; position: absolute; top: 88px" Width="535px">
        ...
        &nbsp;
        <img src="images/ITEMreport.jpg" style="z-index: 102; left: 210px; width: 264px;
            position: absolute; top: 56px; height: 32px" />
