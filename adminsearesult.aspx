<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminsearesult.aspx.cs" Inherits="adminsearesult" %>
        ...
        <div>
            <div>
                ...
                <asp:TextBox ID="TextBox3" runat="server" Enabled="False" Style="z-index: 113; left: 450px;
                    position: absolute; top: 336px" OnTextChanged="TextBox3_TextChanged"></asp:TextBox>
